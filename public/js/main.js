...
// main.js - упрощенная версия для теста
console.log('✅ main.js загружен');

// Простая функция для проверки API
...
// Простой NotificationManager
const NotificationManager = {
    show: (message, type) => {
        alert(message); // Временно используем alert для теста
    }
};

// Простой FileUploader
class FileUploader {
    constructor(options) {
        this.options = options;
    }
    createUploadArea() {
        console.log('FileUploader.createUploadArea');
    }
}

// Простой createModal
function createModal(options) {
    console.log('createModal:', options);
    return { close: () => {} };
}
